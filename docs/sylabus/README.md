...
This directory contains the syllabus for the Time Series Analysis project, guiding mentees through essential topics and concepts needed to complete the project successfully.
...
- Python notebooks (Jupyter) setup and usage
- Data exploration and profiling techniques
- Decomposing trends and seasonality
...
- Statistical significance in autocorrelation analysis
- Time series visualization techniques

*What mentees should be able to DO:*
- Set up and use Jupyter notebooks
- Load, clean, and explore time series datasets with pandas
- Perform seasonal decomposition and interpret results
- Calculate and interpret ACF and PACF plots
- Test for stationarity
- Create time series visualizations
- Best practice for documentation

### Module 2: Classical Time Series Analysis and Introduction to NumPy and Pandas

Introduces classical time series forecasting methods and strengthens Python skills with NumPy and Pandas.
...
*What mentees should be able to DO:*
- Design and implement LSTM and GRU models
